...
DATASET_FORMATS = {'kitti': {'required': ['sequences', 'calib.txt'], 'optional': ['times.txt', 'poses']}, 'euroc': {'required': ['mav0'], 'optional': ['cam0', 'cam1', 'imu0']}, 'tum': {'required': ['rgb.txt', 'depth.txt'], 'optional': ['groundtruth.txt', 'accelerometer.txt']}, 'rosbag': {'required': ['.bag'], 'optional': []}, 'custom': {'required': [], 'optional': []}}
...
METRICS = {'ate': {'name': 'Absolute Trajectory Error', 'unit': 'm'}, 'rpe': {'name': 'Relative Pose Error', 'unit': 'm'}, 'rpe_trans': {'name': 'RPE Translation', 'unit': 'm'}, 'rpe_rot': {'name': 'RPE Rotation', 'unit': 'deg'}, 'success_rate': {'name': 'Success Rate', 'unit': '%'}, 'runtime': {'name': 'Runtime', 'unit': 's'}, 'fps': {'name': 'Frames Per Second', 'unit': 'Hz'}}
...
TASK_REQUIREMENTS = {'navigation': {'accuracy': 0.1, 'precision': 0.05, 'update_rate': 10, 'robustness': 0.95}, 'manipulation': {'accuracy': 0.05, 'precision': 0.02, 'update_rate': 30, 'robustness': 0.98}, 'inspection': {'accuracy': 0.02, 'precision': 0.01, 'update_rate': 5, 'robustness': 0.90}}
